...
Client.prototype._definePort = function(port, endpoint) {
  ...
  for (var name in methods) {
    ...
    def[name + 'Request'] = this._defineRequestMethod(methods[name], location);
    this[name] = def[name];
    this[name + 'Request'] = def[name + 'Request'];
  }
  return def;
};
...
Client.prototype._defineRequestMethod = function(method, location) {
  var self = this;
  var temp;
  return function(args, callback, options, extraHeaders) {
    if (typeof args === 'function') {
    ...
    self._generateRequest(method, args, location, function(error, result, raw, soapHeader) {
      callback(error, result, raw, soapHeader);
    }, options, extraHeaders);
  };
};
...
Client.prototype._generateRequest = function(method, args, location, callback, options, extraHeaders) {
  var self = this,
    name = method.$name,
    input = method.input,
    output = method.output,
