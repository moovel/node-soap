...
WSDL.prototype._initializeOptions = function (options) {
  ...
  if(options.appendNamespaces !== undefined) {
    this.options.appendNamespaces = options.appendNamespaces;
  }
};
...
WSDL.prototype.objectToXML = function(obj, name, nsPrefix, nsURI, isFirst, xmlnsAttr, schemaObject, nsContext) {
  ...
  var xmlnsAttrib = '';
  if (nsURI && isFirst) {
    if (self.options.appendNamespaces) {
      self.options.appendNamespaces.forEach(function(n) {
        xmlnsAttrib += n;
      });
    }
